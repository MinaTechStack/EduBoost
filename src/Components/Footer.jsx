...
export default function Footer() {
    return (
        <div className='w-full bg-[#0f172a] p-4'>
            <div className='max-w-[1240px] mx-auto md:grid grid-cols-4 gap-8 items-start p-5'>
                <div className='col-span-2 p-4'>
                    <h1 className='text-sky-400 font-bold mb-3'>EduBoost</h1>
                    <p className='text-white mb-5 text-justify'>
                        EduBoost is your gateway to interactive and personalized learning. We empower students with resources that make education accessible and effective through modern tech-driven solutions.
                    </p>
